...
public class CoreCecapProfilePresenter extends BaseCecapProfilePresenter implements FamilyProfileContract.InteractorCallBack {
    public CoreCecapProfilePresenter(CecapProfileContract.View view, CecapProfileContract.Interactor interactor, MemberObject memberObject) {
